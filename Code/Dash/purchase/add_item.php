...
if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity'] > $_SESSION['expire_time'])) {
    session_unset();
    session_destroy();
    header("Location: startpage.php?message=Session Expired. Please log in again.");
    exit();
}
...
<nav class="navbar navbar-light bg-light d-flex fixed-top justify-content-between align-items-center">
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
      ...
      <li><button class="dropdown-item text-danger" onclick="showLogoutPopup()">🚪 Logout</button></li>
    </ul>
  </div>
</nav>
...
<div class="content" id="content">
  <div class="form-container mt-5 mb-5">
    ...
    <div class="mt-3 text-center">
      <a href="inventory.php" class="text-decoration-none">&larr; Back to Inventory</a>
    </div>
  </div>
</div>
 <script>
